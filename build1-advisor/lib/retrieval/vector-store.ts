// Pinecone client — Store 1, namespace kalder-v0-2-0, similarity threshold 0.38
//
...
// - Minimum cosine similarity threshold: 0.38
...
// Calibrated against text-embedding-3-small on Kalder corpus. Lowered from
// 0.45 to 0.38 after observing correct top-1 matches (e.g. "what is
// differential_insufficient" -> doc5 §1.2, the governing section) scoring
// 0.40 — below the original threshold despite being the right answer. 0.75
// design target was pre-index and does not apply to this embedding model on
// technical prose.
