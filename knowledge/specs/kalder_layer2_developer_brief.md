...
- Minimum cosine similarity threshold: **0.38** (calibrated against text-embedding-3-small on Kalder corpus; lowered from an initial 0.45 after observing correct top-1 matches score as low as 0.40)
